...
pub struct SampleWeight {
    ...
    len_n: usize,
    //score: Vec<f64>,
    // -> TODO: rename ws -> ws_pad ?
    // Ada
    ws: Option<Vec<f64>>, //len=n
    ps_pad: Option<Vec<f64>>,
    // Logit
    probs: Option<Vec<f64>>, //len=n
    zs_pad: Option<Vec<f64>>,
    wzs_pad: Option<Vec<f64>>,
    wls_pad: Option<Vec<f64>>,
    // config
...
impl SampleWeight {
    ...
    pub fn new(
        ...
        if boost_type.is_type_ada() {
            ...
            let len_n = n + 32;
            let mut ps_pad: Vec<f64> = alloc::with_capacity_align_f64(len_n);
            ...
            // last 32=0.0
            let len_n = n + 32;
            let mut zs_pad: Vec<f64> = alloc::with_capacity_align_f64(len_n);
            zs_pad.resize(len_n, 0.0f64);
            let mut wzs_pad: Vec<f64> = alloc::with_capacity_align_f64(len_n);
            wzs_pad.resize(len_n, 0.0f64);
            let mut wls_pad: Vec<f64> = alloc::with_capacity_align_f64(len_n);
