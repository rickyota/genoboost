...
/// Compressed Sparse Matrix
/// Mainly used for rare genotype.
/// Assume to access by row only.
///
#[derive(Debug, PartialEq, Eq, Clone)]
pub struct SCMatrix {
    inner: Vec<B8>,
    // u32 should be fine
    sample_index: Vec<u32>,
    variant_sample_index: Vec<u32>,
    //variant_indexd: HashMap<u32, u32>,
...
impl BaseSCMatrix for SCMatrix {
    #[inline]
    fn inner(&self) -> &[B8] {
        &self.inner
    }
    ...
    #[inline]
    fn variant_index(&self) -> &HashMap<u32, u32> {
        &self.variant_index
    }
    #[inline]
...
impl<'a> BaseCMatrixMut for SCMatrix {
