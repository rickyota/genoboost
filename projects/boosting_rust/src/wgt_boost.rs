...
use genetics::wgt::{Coef, Model, ModelType, Wgt, WgtKind, WgtTrait};
...
impl WgtBoost {
    ...
    pub fn abcd_sum(&self) -> (f64, f64, f64, f64) {
    ...
    */
    ...
    pub fn write_wgt(&self, dout: &Path, columns: &[String]) {
        ...
        let str = self.string_write(columns);
        //let str = "a\tb\n".to_owned();
